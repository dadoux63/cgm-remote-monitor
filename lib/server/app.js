...
function create (env, ctx) {
  ...
  app.set('trust proxy', 1); // Trust first proxy hop only (e.g. heroku/nginx). Prevents X-Forwarded-For spoofing.
  ...
  // Only use in development - in production it would expose stack traces to clients.
  if (process.env.NODE_ENV === 'development') {
